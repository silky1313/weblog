<template>
  <div class="grid grid-cols-2 h-screen">
    ...
    <div
      class="col-span-2 order-2 p-10 md:col-span-1 md:order-1 bg-black animate__animated animate__bounceInLeft animate__fast"
    >
      ...
      <div class="flex justify-center items-center h-full flex-col">
        ...
        <!-- 指定图片宽度为父级元素的 1/2 -->
        <img src="@/assets/login.svg" class="w-1/2 bg-black" />
      </div>
    </div>
